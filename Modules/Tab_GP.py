...
class General(GenericTab):
    ...
    def __init__(self, parent):
        ...
        self.Box2=[[self.Box1[0][0]+Margin+self.Box1[1][0]     ,self.Box1[0][1]]     ,       [435       , 7*SpacingRow]]
        self.Bx2=wx.StaticBox(self,label='Port Configuration', pos=(self.Box2[0][0], self.Box2[0][1]),size=(self.Box2[1][0], self.Box2[1][1]))

        self.VTx = wx.StaticText(self, label='V', pos=(self.Box2[0][0]+2*Margin+SizeSMUcol, self.Box2[0][1]+2*Margin))
        self.ITx = wx.StaticText(self, label='I', pos=(self.Box2[0][0]+3*Margin+SizeSMUcol+SizeIVcol, self.Box2[0][1]+2*Margin))
        self.MTx = wx.StaticText(self, label='Mode', pos=(self.Box2[0][0]+4*Margin+SizeSMUcol+2*SizeIVcol, self.Box2[0][1]+2*Margin))
        self.FTx = wx.StaticText(self, label='Func/Value', pos=(self.Box2[0][0]+5*Margin+SizeSMUcol+2*SizeIVcol+SizeFMcol, self.Box2[0][1]+2*Margin))
        self.CTx = wx.StaticText(self, label='Comp', pos=(self.Box2[0][0]+6*Margin+SizeSMUcol+2*SizeIVcol+2*SizeFMcol, self.Box2[0][1]+2*Margin))
        self.ETx = wx.StaticText(self, label='Enable', pos=(self.Box2[0][0]+6*Margin+2*SizeSMUcol+2*SizeIVcol+2*SizeFMcol+Margin, self.Box2[0][1]+2*Margin))

        ########################## SMU1 ##########################
        self.SizerSMU1=wx.BoxSizer()
        self.SMU1Tx = wx.StaticText(self, label='SMU1', pos=(self.Box2[0][0]+Margin, self.Box2[0][1]+SpacingRow+4))
        ...
        self.SMU2Tx = wx.StaticText(self, label='SMU2', pos=(self.Box2[0][0]+Margin, self.Box2[0][1]+2*SpacingRow+4))
        ...
        self.SMU3Tx = wx.StaticText(self, label='SMU3', pos=(self.Box2[0][0]+Margin, self.Box2[0][1]+3*SpacingRow+4))
        ...
        self.SMU4Tx = wx.StaticText(self, label='SMU4', pos=(self.Box2[0][0]+Margin, self.Box2[0][1]+4*SpacingRow+4))
        ...
        #========  Var Config ========#
        # BoxN = [[PosX, PoxY],[SizeX,SizeY]]
        Box3=[[self.Box2[0][0]+Margin+self.Box2[1][0]       ,self.Box1[0][1]]        ,[225        , Margin+4*SpacingRow+Margin]]
        self.Bx3=wx.StaticBox(self,label='Var Config', pos=(Box3[0][0],Box3[0][1]),size=(Box3[1][0], Box3[1][1]))
        self.VTx = wx.StaticText(self, label='Start', pos=(Box3[0][0]+2*Margin+SizeSMUcol, Box3[0][1]+2*Margin))
        self.ITx = wx.StaticText(self, label='Stop', pos=(Box3[0][0]+3*Margin+SizeSMUcol+SizeIVcol, Box3[0][1]+2*Margin))
        self.MTx = wx.StaticText(self, label='Step', pos=(Box3[0][0]+4*Margin+SizeSMUcol+2*SizeIVcol, Box3[0][1]+2*Margin))
        ...
        self.VARDTx = wx.StaticText(self, label='VARD', pos=(Box3[0][0]+Margin, Box3[0][1]+2*Margin+3*SpacingRow+4))
        ...
        #======== Axis Config =========#
        Box4=[[Box3[0][0]         , Box3[0][1]+Margin+Box3[1][1]]        ,[225        , Margin+4*SpacingRow]]
